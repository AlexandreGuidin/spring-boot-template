...
public class AuthenticationTest extends BaseControllerTest {
    ...
    @Test
    public void tokenOK() {
        String token = JwtUtils.createJwtToken(Instant.now().plusSeconds(60), "V4CYY1ZzMH6g6tT2GqOtYABiieKuoHci", Collections.emptyMap());
    ...
    public void tokenExpired() {
        String token = JwtUtils.createJwtToken(Instant.now().plusSeconds(-10), "V4CYY1ZzMH6g6tT2GqOtYABiieKuoHci", Collections.emptyMap());
